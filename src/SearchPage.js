    ...
    return (
        <div className="searchPage" >
            ...
            <ChannelRow
                ...
                channel="sammed sankonatti"
                verified
                subs="100M"
                noOfVideos="45"
                description="writing clean clear clever code is very important rather than bit  fast executing code because making the code understand to other developers is what most Important"
